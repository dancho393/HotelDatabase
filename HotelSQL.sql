...
INSERT INTO public.reservations(payment_type_id, guest_id, date_from, date_to,number_guests) VALUES
 (1, 1, '2023-11-01', '2023-11-05',2),
  (2, 2, '2023-11-10', '2023-11-15',2),
  (3, 3, '2023-11-05', '2023-11-08',2)
  (1, 4, '2023-11-20', '2023-11-25',2),
  (4, 3, '2023-11-15', '2023-11-20',2),
  (2, 3, '2023-11-03', '2023-11-07',2),
  (1, 3, '2023-11-08', '2023-11-12',2),
  (3, 3, '2023-11-02', '2023-11-06',2),
  (3, 3, '2023-11-12', '2023-11-17',2),
  (3, 3, '2023-11-22', '2023-11-27',2);
  
  
  INSERT INTO public.reservations(payment_type_id, guest_id, date_from, date_to) VALUES
  (1,1,'2023-12-13','2023-12-15',2);
